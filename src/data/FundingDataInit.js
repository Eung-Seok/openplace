...
function FundingDataInit() {
    const fundingData = [
        ...
        },
        {
            ...
            map: "천안 중앙 놀이공원",
            subTitle: "천안 지역 놀이공원의 놀이기구와 시설 안전 점검을 진행합니다. 놀이기구 작동 상태와 안전 장치 작동 여부를 확인하여 이상이 있을 경우 즉시 보수 조치를 시행합니다. 아이들이 안전하게 놀 수 있는 환경을 확보하기 위해 바닥재, 난간, 출입구 등 주변 시설도 함께 점검하며, 필요 시 개선 및 교체 작업을 진행합니다. 주민 참여형 안전 캠페인과 안내판 설치를 통해 시민들에게 안전 수칙을 안내하며, 정기 점검 계획을 수립하여 장기간 안전성을 유지할 수 있도록 합니다.",
            category: "안전",
            rate: 45,
            goalAmount: 9000000,
            timeLeft: 15,
        ...
        },
        {
            ...
            map: "천안 불당동 어린이놀이터",
            subTitle: "놀이터 주변에 안전펜스를 설치하고, 바닥재와 놀이기구 점검을 통해 아이들이 안전하게 놀 수 있는 공간을 제공합니다. 주민 참여형 이벤트 공간과 안내판 설치를 통해 시민들이 안전 수칙을 숙지하도록 돕습니다. 정기 점검 계획을 수립하여 장기간 안전성을 유지하며, 놀이시설 운영 기록을 관리하여 개선사항을 반영합니다.",
            category: "안전",
            rate: 72,
            goalAmount: 8000000,
            timeLeft: 15,
        ...
        },
        {
            ...
            map: "천안 신부동 중앙공원",
            subTitle: "노후 벤치 교체 및 휴게시설 보강을 통해 시민들이 편안하게 쉴 수 있는 공간을 제공합니다. 공원 내 가로등 LED 교체 및 안전 점검을 통해 야간에도 안전하게 이용할 수 있도록 합니다. 화단 정비, 안내판 설치, 공원 내 CCTV 보강 등을 포함하여 시민들이 안심하고 편하게 공원을 즐길 수 있는 환경을 조성합니다.",
            category: "환경",
            rate: 50,
            goalAmount: 6000000,
            timeLeft: 19,
        ...
        },
        {
            ...
            map: "천안 성정동 어린이집",
            subTitle: "어린이집 주변 울타리와 출입구를 보수하고 CCTV와 안전 표지판 설치로 아이들의 통학 안전을 강화합니다. 놀이터 시설 점검과 바닥재 개선, 주변 산책로 안전 점검도 함께 진행하여 어린이 안전을 확보합니다. 정기 점검 계획을 수립하고 주민들에게 안전 안내를 제공하여 지속적인 안전 관리가 이루어질 수 있도록 합니다.",
            category: "안전",
            rate: 100,
            goalAmount: 5000000,
            timeLeft: 5,
        ...
        },
        {
            ...
            map: "천안 원성동 작은공원",
            subTitle: "공원 내 화단을 정비하고 계절별 꽃을 식재하여 도시 미관을 개선합니다. 주민들이 쾌적하게 이용할 수 있는 산책로와 벤치 주변 조경을 강화합니다. 쓰레기통, 안내판 설치 등 공원 편의 시설도 함께 점검하여 시민 친화적인 공간으로 재탄생시킵니다.",
            category: "환경",
            rate: 33,
            goalAmount: 3500000,
            timeLeft: 24,
        ...
        },
        {
            ...
            map: "천안 성정동 초등학교",
            subTitle: "스쿨존에 CCTV를 설치해 어린이 통학로의 안전을 강화합니다. 횡단보도, 주차 구역, 놀이터 주변 등 취약 구간을 집중 감시합니다. 정기적인 점검과 시스템 유지보수를 통해 장기적으로 안전한 등하굣길 환경을 제공합니다.",
            category: "안전",
            rate: 78,
            goalAmount: 12000000,
            timeLeft: 16,
        ...
        },
        {
            ...
            title: "천안 공원 산책로 정비",
            map: "천안 원성동 공원 산책로",
            subTitle: "산책로 노후 구간을 보수하고 안내 표지판과 안전 표지를 설치합니다. 조명과 안전 난간을 개선하여 시민들이 야간에도 안전하게 산책할 수 있도록 합니다. 정기적인 점검과 청결 관리로 편안하고 쾌적한 공원 환경을 유지합니다.",
            category: "환경",
            rate: 61,
            goalAmount: 6000000,
            timeLeft: 20,
        ...
        },
        {
            ...
            map: "천안 불당동 놀이터",
            subTitle: "놀이기구 아래 바닥 안전재를 교체하여 아이들이 안전하게 놀 수 있는 환경을 제공합니다. 충격 흡수 매트, 미끄럼 방지 처리 등을 포함해 종합적인 안전 조치를 실시합니다. 정기 점검 및 유지보수 체계를 마련하여 장기적으로 안전을 보장합니다.",
            category: "안전",
            rate: 55,
            goalAmount: 7500000,
            timeLeft: 17,
        ...
        },
        {
            ...
            map: "천안 신부동 중앙공원",
            subTitle: "공원 내 화단과 조경을 정비하여 시민들이 쾌적하게 쉴 수 있는 환경을 제공합니다. 계절별 꽃과 관목을 식재하고, 산책로 주변 조명을 보강합니다. 공원 내 쓰레기 관리, 벤치, 안내판 설치 등 편의 시설도 함께 개선하여 이용 만족도를 높입니다.",
            category: "환경",
            rate: 70,
            goalAmount: 5000000,
            timeLeft: 23,
        ...
        },
        {
            ...
            map: "천안 성정동 초등학교",
            subTitle: "운동장 주변 안전망을 설치하여 체육활동 시 안전을 강화합니다. 낙하물, 공 튐 방지, 외부 접근 통제까지 포함한 종합 안전 대책을 마련합니다. 정기 점검과 유지보수 계획으로 학생들이 안심하고 체육활동을 즐길 수 있는 환경을 제공합니다.",
            category: "안전",
            rate: 48,
            goalAmount: 8000000,
            timeLeft: 19,
        ...
        },
        {
            ...
            map: "천안 두정동 놀이공원",
            subTitle: "놀이시설 안전점검과 보수를 통해 아이들이 안심하고 놀 수 있는 환경을 조성합니다. 놀이기구의 구조적 안정성, 바닥재, 안전 가드 등을 점검하고 필요한 개선 작업을 실시합니다. 정기 점검과 유지보수 체계로 아이들의 안전을 지속적으로 보장합니다.",
            category: "안전",
            rate: 49,
            goalAmount: 7000000,
            timeLeft: 18,
        ...
        },
        {
            ...
            map: "천안 원성동 놀이터",
            subTitle: "노후 놀이기구를 교체하여 아이들이 안전하게 놀 수 있는 환경을 제공합니다. 미끄럼틀, 그네, 정글짐 등 놀이기구의 구조적 안전성을 점검하고 보강합니다. 정기 점검과 유지보수를 포함해 아이들이 안심하고 놀이를 즐길 수 있는 공간을 마련합니다.",
            category: "안전",
            rate: 58,
            goalAmount: 8500000,
            timeLeft: 19,
        ...
        },
        {
            ...
            map: "천안 두정동 공원",
            subTitle: "산책로 노후 구간을 보수하고 안전 표지판을 설치합니다. 조명과 난간을 보강하여 야간 산책 시 안전성을 높입니다. 쓰레기통 설치와 유지보수를 병행하여 시민들이 쾌적하게 이용할 수 있는 환경을 제공합니다.",
            category: "환경",
            rate: 44,
            goalAmount: 5000000,
            timeLeft: 21,
        ...
        },
        {
            ...
            map: "천안 신부동 공원",
            subTitle: "노후 벤치를 교체하여 시민들이 편안하게 휴식할 수 있는 공간을 제공합니다. 파고라, 테이블 등 주변 시설도 개선하여 쾌적한 공원 환경을 조성합니다. 정기 점검과 유지보수를 통해 장기적으로 안전하고 편리한 공간을 제공합니다.",
            category: "환경",
            rate: 55,
            goalAmount: 6500000,
            timeLeft: 18,
        ...
        },
        {
            ...
            map: "천안 두정동 어린이놀이터",
            subTitle: "놀이기구 주변 안전 펜스를 설치하여 아이들이 안전하게 놀 수 있는 환경을 제공합니다. 출입구, 그네, 미끄럼틀 등 주요 구역을 중심으로 설치하며, 안전사고 예방을 최우선으로 합니다. 정기 점검과 유지보수로 아이들이 안심하고 놀이를 즐길 수 있도록 지속 관리합니다.",
            category: "안전",
            rate: 53,
            goalAmount: 7500000,
            timeLeft: 18,
        ...
        },
        {
            ...
            map: "천안 성정동 초등학교",
            subTitle: "운동장 노후 구간 보수와 안전망 설치로 학생들의 안전을 강화합니다. 트랙, 체육 시설, 놀이 공간 등을 점검하고 필요 시 바닥재 교체 및 라인 재도색을 진행합니다. 정기 점검과 유지보수로 안전한 체육 환경을 장기적으로 유지합니다.",
            category: "안전",
            rate: 67,
            goalAmount: 9500000,
            timeLeft: 22,
        ...
        },
        {
            ...
            map: "천안 원성동 공원",
            subTitle: "공원 화단을 정비하고 계절별 꽃을 식재하여 도시 미관을 개선합니다. 벤치, 파고라, 산책로 주변 환경을 함께 개선하여 쾌적한 휴식 공간을 제공합니다. 정기 점검과 유지보수로 장기적으로 안전하고 아름다운 공원 환경을 유지합니다.",
            category: "환경",
            rate: 58,
            goalAmount: 7000000,
            timeLeft: 19,
        ...
        },
        {
            ...
            map: "천안 두정동 놀이터",
            subTitle: "노후 놀이기구를 보수하여 아이들이 안전하게 놀 수 있는 환경을 제공합니다. 미끄럼틀, 그네, 정글짐 등 주요 시설의 점검과 교체를 포함하며, 안전 펜스 설치도 함께 진행합니다. 정기 점검과 유지보수로 지속적으로 안전하고 쾌적한 놀이터 환경을 제공합니다.",
            category: "안전",
            rate: 62,
            goalAmount: 8000000,
            timeLeft: 18,
